...
-- DropForeignKey
ALTER TABLE "TaskDependency" DROP CONSTRAINT "TaskDependency_dependentTaskId_fkey";

-- DropForeignKey
ALTER TABLE "TaskDependency" DROP CONSTRAINT "TaskDependency_prerequisiteTaskId_fkey";

-- AlterTable
ALTER TABLE "Task" ADD COLUMN     "degree" INTEGER,
